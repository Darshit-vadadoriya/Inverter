...
class MaintenanceSchedule(TransactionBase):
	...
	def generate_schedule(self):
		...
		for d in self.get("items"):
			...
			s_list = []
			s_list = self.create_schedule_list(d.start_date, d.end_date, d.no_of_visits, d.sales_person, d.custom_technician)
			for i in range(d.no_of_visits):
				...
				child.idx = count
				count = count + 1
				child.custom_technician = d.custom_technician
	...
	def create_schedule_list(self, start_date, end_date, no_of_visit, sales_person, custom_technician):
		schedule_list = []
